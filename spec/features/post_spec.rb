...
describe 'navigate' do
  ...
  let(:post) { 
    Post.create(date: Date.today, rationale: "im top of the world", user_id: user.id)}
  ...
  describe do 
    it "delete" do 
      ...
      post_to_delete = Post.create(date: Date.today, rationale: "blah blh", user_id: delete_user.id)
